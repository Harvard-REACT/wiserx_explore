...
cp $dir_path/csi_$1.dat $dir_path/csi_backup_data/csi_$1_$timestamp.dat &
cp $dir_path/motorjoint_displacement.csv $dir_path/motor_joint_backup_data/motorjoint_displacement_${timestamp}.csv
