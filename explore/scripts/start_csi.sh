...
echo "abc123" | sudo -S ${HOME}/WSR-Toolbox-linux-80211n-csitool-supplementary/netlink/log_to_file ${HOME}/catkin_ws/src/react-m_explore/explore/data/temp_csi_$1.dat &
